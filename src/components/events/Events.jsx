...
const Events = () => {
  ...
  const handleCopyEvent = (eventCode) => navigator.clipboard.writeText(eventCode);
  const handleViewEdit = (eventId) => console.log('View/Edit event:', eventId);
  const handleDownloadReports = (eventId) => console.log('Download reports for:', eventId);
  ...
  return (
    <div className="w-full  p-4 md:p-6 lg:p-8">
      ...
      {loading ? (
        ...
        <div className="py-10 text-center text-gray-500">No events available.</div>
      ) : (
        <>
          <div className="grid grid-cols-2 sm:grid-cols-6 gap-4 px-6 py-3 font-bold text-black bg-gray-50 font-lg">
