...
const handleDownloadReports = async (eventId) => {
  ...
  return (
    <div className="bg-gray-50 px-6 py-4 text-gray-700">
      <div className="mb-4 font-medium text-slate-500">User Registration Status...</div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-4 text-center">
        ...
        <div><strong>Checked-In:</strong> {event.checkedIn}</div>
      </div>

      <div className="flex flex-wrap gap-2">
        <button
          onClick={() => handleDownloadReports(event.eventId)}
          className="bg-[#FF0808] text-white  px-4 py-2  hover:bg-orange-600 rounded-xl"
        >
        ...
        <button
          ...
          className="bg-[#FF0808] text-white  px-4 py-2 rounded-xl hover:bg-orange-600"
        >
